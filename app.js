(function() {
    ...
    style.innerHTML = `
        ...
        .inj-action-btn, a.inj-action-btn {
            box-sizing: border-box; display: block; width: 100%; padding: 10px; margin-bottom: 10px;
    ...
    // Mencegah klik di dalam menu mempengaruhi website di belakangnya (Mencegah menu tertutup sendiri oleh web)
    ...
    document.getElementById('btn-login-bkn').onclick = function(e) {
        e.preventDefault();
        var btn = this;
        btn.innerHTML = '✅ Sistem Aktif berjalan di latar belakang!';
