(function() {
    ...
    var oldMenu = document.getElementById('menu-injector-dapodik');
    ...
    document.getElementById('btn-view-dapodik').onclick = function(e) { e.preventDefault(); switchView('inj-view-main', 'inj-view-dapodik'); };
    document.getElementById('btn-view-pip').onclick = function(e) { e.preventDefault(); switchView('inj-view-main', 'inj-view-pip'); };
    document.getElementById('btn-view-datadik').onclick = function(e) { e.preventDefault(); switchView('inj-view-main', 'inj-view-datadik'); };
    document.getElementById('btn-view-bkn').onclick = function(e) { e.preventDefault(); switchView('inj-view-main', 'inj-view-bkn'); };
    document.getElementById('btn-view-link').onclick = function(e) { e.preventDefault(); switchView('inj-view-main', 'inj-view-link'); };
    document.getElementById('btn-back-dapodik').onclick = function(e) { e.preventDefault(); switchView('inj-view-dapodik', 'inj-view-main'); };
    document.getElementById('btn-back-pip').onclick = function(e) { e.preventDefault(); switchView('inj-view-pip', 'inj-view-main'); };
    document.getElementById('btn-back-datadik').onclick = function(e) { e.preventDefault(); switchView('inj-view-datadik', 'inj-view-main'); };
    document.getElementById('btn-back-bkn').onclick = function(e) { e.preventDefault(); switchView('inj-view-bkn', 'inj-view-main'); };
    document.getElementById('btn-back-link').onclick = function(e) { e.preventDefault(); switchView('inj-view-link', 'inj-view-main'); };

    // 5. FUNGSI-FUNGSI TOMBOL AKSI
