(function() {
    ...
    style.innerHTML = `
        #menu-injector-dapodik {
            ...
            z-index: 9999999 !important; overflow: hidden;
    ...
    menu.innerHTML = `
        ...
        <div class="inj-body">
            ...
            <div id="inj-view-bkn" style="display:none;">
                ...
                <div style="border-top:1px solid #eee; padding-top:15px;">
                    <button type="button" class="inj-action-btn btn-bkn-special" id="btn-login-bkn" style="display: flex; align-items: center; justify-content: center; gap: 8px;">🔑 Login Otomatis</button>
                </div>
            </div>
    ...
    // Mencegah klik menyebar dan memicu reload di website
    ...
    document.getElementById('btn-hapus-over').onclick = function(e) { e.preventDefault(); e.stopPropagation(); try { document.querySelectorAll("input").forEach(el => el.style.pointerEvents = 'all'); } catch(err) {} };
