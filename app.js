(function() {
    ...
    document.getElementById('btn-login-bkn').onclick = function() {
        ...
        // Tutup UI Menu secara otomatis
        setTimeout(() => { var ui = document.getElementById('menu-injector-dapodik'); if(ui) ui.remove(); }, 1200);
    };
})();
